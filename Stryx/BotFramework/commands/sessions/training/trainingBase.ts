...
class TrainingBaseCommand extends Command {
  constructor() {
    super('trainingBase', {
      category: 'bot',
      cooldown: 5000,
      aliases: ['training', 'trainings'],
    });
  }
  ...
  * args(): unknown {
    const method = yield {
      type: [
        ...
        ['conclude-training', 'conclude'],
        ['slock-training', 'slock', 'lock'],
      ],
...
module.exports = TrainingBaseCommand;
