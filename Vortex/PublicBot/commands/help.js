...
const Help = {
  ...
  execute: async function(client, msg, args, embed, guildSettings) {
      let categories = ["roblox", "moderation", "utility", "tickets", "sessions"]
      embed.setDescription("The full command list is found [here](https://docs.vortexhq.net/commands). If you need anything else, please join our [Support Server](https://discord.gg/cbRSPFc6TV)!")
      if (!args[0]) {
          ...
          if (!categories.includes(args[0].toLowerCase())) {
              embed.setDescription(`Hm.. I was unable to find that catagory! Please say ${guildSettings.prefix}help to see a list of categories.`)
